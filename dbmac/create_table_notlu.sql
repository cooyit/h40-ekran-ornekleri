...
CREATE TABLE diller (
    ...
    dil_adi VARCHAR(64),
	silindi_mi BOOLEAN NOT NULL DEFAULT FALSE,       -- Soft delete işaret kolonu
    silinme_tarihi TIMESTAMPTZ                      -- Silinme zamanı (nullable)
);
...
CREATE TABLE model_ulke (
    ...
    aktif BOOLEAN,                  -- 0: atanmış ama geçerli değil, 1: devrede
...
-- gosterge_cevap_sablonu tablosu
...
CREATE TABLE gosterge_cevap_sablonu (
